    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DotaDraftSimulator.Models.HeroDb>
    {
        ...
        protected override void Seed(DotaDraftSimulator.Models.HeroDb context)
        {
            context.Heroes.AddOrUpdate(x => x.Name, new Hero[] { 
                ...
                new Hero("Ancient Apparition",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,1,5),
                new Hero("Bane",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,2,5),
                new Hero("Batrider",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,3,5,2),
                new Hero("Chen",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,1,2,5),
                ...
                new Hero("Dark Willow", Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,2,3,1,5),
                new Hero("Dazzle", Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,1,5),
                new Hero("Death Prophet",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,4,5,3,1),
                new Hero("Disruptor",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,1,1,5),
                new Hero("Enchantress",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,2,2,4,4),
                new Hero("Enigma",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,1,5,1),
                new Hero("Invoker",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,2,5,2,1),
                new Hero("Jakiro",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,3,4,5),
                new Hero("Keeper of the Light",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,1,2,5),
                new Hero("Leshrac",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,4,5,3,4),
                new Hero("Lich",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,3,5),
                new Hero("Lina",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,2,5,1,2),
                new Hero("Lion",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,1,5),
                new Hero("Nature's Prophet",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,3,2,5,4),
                new Hero("Necrophos",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,4,4,4,1),
                new Hero("Ogre Magi",Hero.MainAttribute.Intelligence,Hero.AttackType.Melee,1,1,2,5),
                new Hero("Oracle",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,1,5),
                new Hero("Outworld Devourer",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,4,5,1,1),
                new Hero("Puck",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,5,3,2),
                new Hero("Pugna",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,4,5,3,3),
                new Hero("Queen of Pain",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,3,5,3,1),
                new Hero("Rubick",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,1,5),
                new Hero("Shadow Demon",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,2,5),
                new Hero("Shadow Shaman",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,2,1,5),
                new Hero("Silencer",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,3,4,1,5),
                new Hero("Skywrath Mage",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,3,1,5),
                new Hero("Storm Spirit",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,3,5,1,1),
                ...
                new Hero("Zeus",Hero.MainAttribute.Intelligence,Hero.AttackType.Ranged,1,5,3,3) 
            });
        }
    }
}
